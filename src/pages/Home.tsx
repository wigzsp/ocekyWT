...
export default function Home() {
  ...
  return <>
    ...
    <section className="border-y border-slate-800 bg-panel/45"><div className="shell py-16"><p className="eyebrow">clear by design</p><h2 className="mt-2 text-3xl font-black text-white">Почему ocekyWT</h2><div className="mt-9 grid gap-5 md:grid-cols-3"><Feature icon={ListFilter} title="Подробные характеристики" text="Ранг, GE, нации и техника собраны в карточке товара — без поиска по переписке." /><Feature icon={Gem} title="Скриншоты техники" text="По скриншотам можно сразу увидеть содержимое лота и понять, что именно вы покупаете." /><Feature icon={ShieldCheck} title="Прямая покупка через FunPay" text="Витрина направляет к конкретному объявлению на FunPay. Оплата не обрабатывается на этом сайте." /></div></div></section>
  </>
}
